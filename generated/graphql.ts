...
/** The agent type */
export type Agent = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  __typename?: 'Agent';
  /**
   ...
   */
  agentId: Scalars['Int'];
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Agents&quot; was set to Show in GraphQL. */
  agentsAcf?: Maybe<Agent_Agentsacf>;
  /** Connection between the agent type and the category type */
  categories?: Maybe<AgentToCategoryConnection>;
  ...
  /** The globally unique identifier of the agents object. */
  id: Scalars['ID'];
  ...
  /** Connection between the agent type and the tag type */
  tags?: Maybe<AgentToTagConnection>;
  /** The template assigned to the node */
  template?: Maybe<ContentTemplate>;
  /** Connection between the agent type and the TermNode type */
  terms?: Maybe<AgentToTermNodeConnection>;
...
/** The agent type */
export type AgentCategoriesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<AgentToCategoryConnectionWhereArgs>;
};
...
/** The agent type */
export type AgentTagsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<AgentToTagConnectionWhereArgs>;
};


/** The agent type */
export type AgentTermsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<AgentToTermNodeConnectionWhereArgs>;
};
...
/** Set relationships between the agent to categories */
export type AgentCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<AgentCategoriesNodeInput>>>;
};

/** List of categories to connect the agent to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type AgentCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']>;
  /** The ID of the category. If present, this will be used to connect to the agent. If no existing category exists with this ID, no connection will be made. */
...
/** Set relationships between the agent to tags */
export type AgentTagsInput = {
  /** If true, this will append the tag to existing related tags. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<AgentTagsNodeInput>>>;
};

/** List of tags to connect the agent to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type AgentTagsNodeInput = {
  /** The description of the tag. This field is used to set a description of the tag if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']>;
  /** The ID of the tag. If present, this will be used to connect to the agent. If no existing tag exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']>;
...
/** Connection between the agent type and the category type */
export type AgentToCategoryConnection = {
  __typename?: 'AgentToCategoryConnection';
  /** Edges for the AgentToCategoryConnection connection */
  edges?: Maybe<Array<Maybe<AgentToCategoryConnectionEdge>>>;
...
export type AgentToCategoryConnectionEdge = {
  __typename?: 'AgentToCategoryConnectionEdge';
...
/** Arguments for filtering the AgentToCategoryConnection connection */
export type AgentToCategoryConnectionWhereArgs = {
...
/** Connection between the agent type and the agent type */
export type AgentToPreviewConnectionEdge = {
  __typename?: 'AgentToPreviewConnectionEdge';
  /** The node of the connection, without the edges */
  node?: Maybe<Agent>;
};

/** Connection between the agent type and the tag type */
export type AgentToTagConnection = {
  __typename?: 'AgentToTagConnection';
  /** Edges for the AgentToTagConnection connection */
  edges?: Maybe<Array<Maybe<AgentToTagConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
...
/** An edge in a connection */
export type AgentToTagConnectionEdge = {
  __typename?: 'AgentToTagConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Tag>;
...
/** Arguments for filtering the AgentToTagConnection connection */
export type AgentToTagConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Connection between the agent type and the TermNode type */
export type AgentToTermNodeConnection = {
  __typename?: 'AgentToTermNodeConnection';
  /** Edges for the AgentToTermNodeConnection connection */
  edges?: Maybe<Array<Maybe<AgentToTermNodeConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
...
/** An edge in a connection */
export type AgentToTermNodeConnectionEdge = {
  __typename?: 'AgentToTermNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<TermNode>;
...
/** Arguments for filtering the AgentToTermNodeConnection connection */
export type AgentToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Field Group */
export type Agent_Agentsacf = AcfFieldGroup & {
  __typename?: 'Agent_Agentsacf';
  email?: Maybe<Scalars['String']>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
  phoneNumber1?: Maybe<Scalars['String']>;
  phoneNumber2?: Maybe<Scalars['String']>;
  picture?: Maybe<MediaItem>;
...
export type Category = DatabaseIdentifier & HierarchicalTermNode & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'Category';
  /** Connection between the category type and the agent type */
...
/** The category type */
export type CategoryAllAgentsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<CategoryToAgentConnectionWhereArgs>;
};


/** The category type */
export type CategoryAllListingArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** Connection between the category type and the agent type */
export type CategoryToAgentConnection = {
  __typename?: 'CategoryToAgentConnection';
  /** Edges for the CategoryToAgentConnection connection */
  edges?: Maybe<Array<Maybe<CategoryToAgentConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
...
/** An edge in a connection */
export type CategoryToAgentConnectionEdge = {
  __typename?: 'CategoryToAgentConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Agent>;
...
/** Arguments for filtering the CategoryToAgentConnection connection */
export type CategoryToAgentConnectionWhereArgs = {
  /** Category ID */
...
/** Connection between the category type and the listing type */
export type CategoryToListingConnection = {
  __typename?: 'CategoryToListingConnection';
  /** Edges for the CategoryToListingConnection connection */
  edges?: Maybe<Array<Maybe<CategoryToListingConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
...
/** An edge in a connection */
export type CategoryToListingConnectionEdge = {
  __typename?: 'CategoryToListingConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Listing>;
...
export type ContentRevisionUnion = Listing | Page | Post;
...
export type CreateAgentInput = {
  /** Set connections between the agent and categories */
  categories?: InputMaybe<AgentCategoriesInput>;
  ...
  status?: InputMaybe<PostStatusEnum>;
  /** Set connections between the agent and tags */
  tags?: InputMaybe<AgentTagsInput>;
...
export type CreateListingInput = {
  /** Set connections between the listing and categories */
  categories?: InputMaybe<ListingCategoriesInput>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  ...
  /** The status of the object */
  status?: InputMaybe<PostStatusEnum>;
  /** Set connections between the listing and tags */
  tags?: InputMaybe<ListingTagsInput>;
  /** The title of the object */
  title?: InputMaybe<Scalars['String']>;
...
/** Input for the createSiteSetting mutation */
...
/** The payload for the createSiteSetting mutation */
export type CreateSiteSettingPayload = {
  __typename?: 'CreateSiteSettingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
...
/** Input for the deleteSiteSetting mutation */
export type DeleteSiteSettingInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** Whether the object should be force deleted instead of being moved to the trash */
  forceDelete?: InputMaybe<Scalars['Boolean']>;
  /** The ID of the siteSetting to delete */
  id: Scalars['ID'];
};

/** The payload for the deleteSiteSetting mutation */
export type DeleteSiteSettingPayload = {
  __typename?: 'DeleteSiteSettingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The ID of the deleted object */
  deletedId?: Maybe<Scalars['ID']>;
...
/** The listing type */
export type Listing = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & NodeWithTrackbacks & UniformResourceIdentifiable & {
  __typename?: 'Listing';
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Listings&quot; was set to Show in GraphQL. */
  acf?: Maybe<Listing_Acf>;
  /** Connection between the listing type and the category type */
  categories?: Maybe<ListingToCategoryConnection>;
  ...
  modifiedGmt?: Maybe<Scalars['String']>;
  /** Other Properties */
  otherProperties?: Maybe<Array<Maybe<OtherPropertyField>>>;
  /** Whether the pings are open or closed for this particular post. */
  pingStatus?: Maybe<Scalars['String']>;
  /** URLs that have been pinged. */
  pinged?: Maybe<Array<Maybe<Scalars['String']>>>;
  /** Connection between the listing type and the listing type */
  preview?: Maybe<ListingToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']>;
  /** Images */
  propertyImages?: Maybe<Array<Maybe<MediaItem>>>;
  /** If the current node is a revision, this field exposes the node this is a revision of. Returns null if the node is not a revision of another node. */
  revisionOf?: Maybe<NodeWithRevisionsToContentNodeConnectionEdge>;
  /** Connection between the listing type and the listing type */
  revisions?: Maybe<ListingToRevisionConnection>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']>;
  /** Connection between the listing type and the tag type */
  tags?: Maybe<ListingToTagConnection>;
  /** The template assigned to a node of content */
  template?: Maybe<ContentTemplate>;
  /** Connection between the listing type and the TermNode type */
  terms?: Maybe<ListingToTermNodeConnection>;
  /** The title of the post. This is currently just the raw title. An amendment to support rendered title needs to be made. */
  title?: Maybe<Scalars['String']>;
  /** URLs queued to be pinged. */
  toPing?: Maybe<Array<Maybe<Scalars['String']>>>;
  /** Get specific translation version of this object */
  translation?: Maybe<Listing>;
  /** List all translated versions of this post */
  translations?: Maybe<Array<Maybe<Listing>>>;
  /** The unique resource identifier path */
  uri?: Maybe<Scalars['String']>;
};
...
/** The listing type */
export type ListingCategoriesArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<ListingToCategoryConnectionWhereArgs>;
};


/** The listing type */
export type ListingContentArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The listing type */
export type ListingEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The listing type */
export type ListingEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The listing type */
export type ListingRevisionsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<ListingToRevisionConnectionWhereArgs>;
};
...
export type ListingTagsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<ListingToTagConnectionWhereArgs>;
};
...
export type ListingTermsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<ListingToTermNodeConnectionWhereArgs>;
};


/** The listing type */
export type ListingTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};


/** The listing type */
export type ListingTranslationArgs = {
  language: LanguageCodeEnum;
};

/** Set relationships between the listing to categories */
export type ListingCategoriesInput = {
  /** If true, this will append the category to existing related categories. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<ListingCategoriesNodeInput>>>;
};

/** List of categories to connect the listing to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ListingCategoriesNodeInput = {
  /** The description of the category. This field is used to set a description of the category if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']>;
  /** The ID of the category. If present, this will be used to connect to the listing. If no existing category exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']>;
  /** The name of the category. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']>;
  /** The slug of the category. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Set relationships between the listing to tags */
export type ListingTagsInput = {
  /** If true, this will append the tag to existing related tags. If false, this will replace existing relationships. Default true. */
  append?: InputMaybe<Scalars['Boolean']>;
  /** The input list of items to set. */
  nodes?: InputMaybe<Array<InputMaybe<ListingTagsNodeInput>>>;
};

/** List of tags to connect the listing to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ListingTagsNodeInput = {
  /** The description of the tag. This field is used to set a description of the tag if a new one is created during the mutation. */
  description?: InputMaybe<Scalars['String']>;
  /** The ID of the tag. If present, this will be used to connect to the listing. If no existing tag exists with this ID, no connection will be made. */
  id?: InputMaybe<Scalars['ID']>;
  /** The name of the tag. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name?: InputMaybe<Scalars['String']>;
  /** The slug of the tag. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
...
/** Connection between the listing type and the category type */
export type ListingToCategoryConnection = {
  __typename?: 'ListingToCategoryConnection';
  /** Edges for the ListingToCategoryConnection connection */
  edges?: Maybe<Array<Maybe<ListingToCategoryConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Category>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type ListingToCategoryConnectionEdge = {
  __typename?: 'ListingToCategoryConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Category>;
...
/** Arguments for filtering the ListingToCategoryConnection connection */
export type ListingToCategoryConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Connection between the listing type and the listing type */
export type ListingToPreviewConnectionEdge = {
  __typename?: 'ListingToPreviewConnectionEdge';
  /** The node of the connection, without the edges */
  node?: Maybe<Listing>;
};

/** Connection between the listing type and the listing type */
export type ListingToRevisionConnection = {
  __typename?: 'ListingToRevisionConnection';
  /** Edges for the listingToRevisionConnection connection */
  edges?: Maybe<Array<Maybe<ListingToRevisionConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Listing>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type ListingToRevisionConnectionEdge = {
  __typename?: 'ListingToRevisionConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Listing>;
...
export type ListingToRevisionConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
...
/** Connection between the listing type and the tag type */
export type ListingToTagConnection = {
  __typename?: 'ListingToTagConnection';
  /** Edges for the ListingToTagConnection connection */
  edges?: Maybe<Array<Maybe<ListingToTagConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Tag>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type ListingToTagConnectionEdge = {
  __typename?: 'ListingToTagConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Tag>;
...
/** Arguments for filtering the ListingToTagConnection connection */
export type ListingToTagConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Connection between the listing type and the TermNode type */
export type ListingToTermNodeConnection = {
  __typename?: 'ListingToTermNodeConnection';
  /** Edges for the ListingToTermNodeConnection connection */
  edges?: Maybe<Array<Maybe<ListingToTermNodeConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<TermNode>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type ListingToTermNodeConnectionEdge = {
  __typename?: 'ListingToTermNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<TermNode>;
...
/** Arguments for filtering the ListingToTermNodeConnection connection */
export type ListingToTermNodeConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain?: InputMaybe<Scalars['String']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf?: InputMaybe<Scalars['Int']>;
...
/** Field Group */
export type Listing_Acf = AcfFieldGroup & {
  __typename?: 'Listing_Acf';
  address?: Maybe<Scalars['String']>;
  agent?: Maybe<Listing_Acf_Agent>;
  area?: Maybe<Scalars['String']>;
  /** 7:3 or 7:4 ratio recommended */
...
export type OtherPropertyField = {
  __typename?: 'OtherPropertyField';
...
export type RootMutation = {
  ...
  /** The payload for the createSiteSetting mutation */
  createSiteSetting?: Maybe<CreateSiteSettingPayload>;
  /** The payload for the createTag mutation */
  ...
  /** The payload for the deleteSiteSetting mutation */
  deleteSiteSetting?: Maybe<DeleteSiteSettingPayload>;
  /** The payload for the deleteTag mutation */
  ...
  /** The payload for the updateSiteSetting mutation */
  updateSiteSetting?: Maybe<UpdateSiteSettingPayload>;
...
/** The root mutation */
export type RootMutationCreateSiteSettingArgs = {
...
/** The root mutation */
export type RootMutationDeleteSiteSettingArgs = {
...
/** The root mutation */
export type RootMutationUpdateListingArgs = {
...
/** The root mutation */
export type RootMutationUpdateSiteSettingArgs = {
...
export type RootQuery = {
  ...
  /** An object of the agent Type. Agents */
  agent?: Maybe<Agent>;
  /**
   * A agent object
  ...
  allSiteSettings?: Maybe<RootQueryToSiteSettingConnection>;
  ...
  /** An object of the listing Type. Property listings */
  listing?: Maybe<Listing>;
  /**
   * A listing object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
  ...
  /** An object of the siteSetting Type. Post Type Description */
  siteSetting?: Maybe<SiteSetting>;
  /**
   * A siteSetting object
   * @deprecated Deprecated in favor of using the single entry point for this type with ID and IDType fields. For example, instead of postBy( id: &quot;&quot; ), use post(id: &quot;&quot; idType: &quot;&quot;)
   */
  siteSettingBy?: Maybe<SiteSetting>;
  /** A 0bject */
  tag?: Maybe<Tag>;
...
/** The root entry point into the Graph */
export type RootQueryAllListingArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToListingConnectionWhereArgs>;
};
...
export type RootQueryAllSiteSettingsArgs = {
  ...
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<RootQueryToSiteSettingConnectionWhereArgs>;
};
...
/** The root entry point into the Graph */
export type RootQueryListingArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  idType?: InputMaybe<ListingIdType>;
};
...
/** The root entry point into the Graph */
export type RootQuerySiteSettingArgs = {
  asPreview?: InputMaybe<Scalars['Boolean']>;
  id: Scalars['ID'];
  idType?: InputMaybe<SiteSettingIdType>;
};


/** The root entry point into the Graph */
export type RootQuerySiteSettingByArgs = {
  id?: InputMaybe<Scalars['ID']>;
  siteSettingId?: InputMaybe<Scalars['Int']>;
  slug?: InputMaybe<Scalars['String']>;
  uri?: InputMaybe<Scalars['String']>;
};
...
/** Connection between the RootQuery type and the agent type */
export type RootQueryToAgentConnection = {
  __typename?: 'RootQueryToAgentConnection';
  /** Edges for the RootQueryToAgentConnection connection */
  edges?: Maybe<Array<Maybe<RootQueryToAgentConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Agent>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type RootQueryToAgentConnectionEdge = {
  __typename?: 'RootQueryToAgentConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Agent>;
...
/** Connection between the RootQuery type and the listing type */
export type RootQueryToListingConnection = {
  __typename?: 'RootQueryToListingConnection';
  /** Edges for the RootQueryToListingConnection connection */
  edges?: Maybe<Array<Maybe<RootQueryToListingConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Listing>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type RootQueryToListingConnectionEdge = {
  __typename?: 'RootQueryToListingConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Listing>;
...
export type RootQueryToListingConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
  ...
  /** Array of IDs for the objects to retrieve */
  in?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
  /** Filter by Listings by language code (Polylang) */
  language?: InputMaybe<LanguageCodeFilterEnum>;
...
/** Connection between the RootQuery type and the siteSetting type */
export type RootQueryToSiteSettingConnection = {
  __typename?: 'RootQueryToSiteSettingConnection';
  /** Edges for the RootQueryToSiteSettingConnection connection */
  edges?: Maybe<Array<Maybe<RootQueryToSiteSettingConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<SiteSetting>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
};

/** An edge in a connection */
export type RootQueryToSiteSettingConnectionEdge = {
  __typename?: 'RootQueryToSiteSettingConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<SiteSetting>;
};

/** Arguments for filtering the RootQueryToSiteSettingConnection connection */
export type RootQueryToSiteSettingConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery?: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword?: InputMaybe<Scalars['Boolean']>;
...
/** The siteSetting type */
export type SiteSetting = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithTemplate & NodeWithTitle & UniformResourceIdentifiable & {
  ...
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid?: Maybe<Scalars['String']>;
  /** The globally unique identifier of the site_settings object. */
  id: Scalars['ID'];
  /** Whether the node is a Content Node */
  isContentNode: Scalars['Boolean'];
  /** Whether the object is a node in the preview state */
  ...
  /** The GMT modified time for a post. If a post was recently updated the modified field will change to match the corresponding time in GMT. */
  modifiedGmt?: Maybe<Scalars['String']>;
  /** Connection between the siteSetting type and the siteSetting type */
  preview?: Maybe<SiteSettingToPreviewConnectionEdge>;
  /** The database id of the preview node */
  previewRevisionDatabaseId?: Maybe<Scalars['Int']>;
  /** Whether the object is a node in the preview state */
  previewRevisionId?: Maybe<Scalars['ID']>;
  /** Added to the GraphQL Schema because the ACF Field Group &quot;Settings&quot; was set to Show in GraphQL. */
  settingsPage?: Maybe<SiteSetting_Settingspage>;
  /**
   * The id field matches the WP_Post-&gt;ID field.
   * @deprecated Deprecated in favor of the databaseId field
   */
  siteSettingId: Scalars['Int'];
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug?: Maybe<Scalars['String']>;
  /** The current status of the object */
  status?: Maybe<Scalars['String']>;
...
/** The siteSetting type */
export type SiteSettingEnqueuedScriptsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The siteSetting type */
export type SiteSettingEnqueuedStylesheetsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** The siteSetting type */
export type SiteSettingTitleArgs = {
  format?: InputMaybe<PostObjectFieldFormatEnum>;
};

/** The Type of Identifier used to fetch a single resource. Default is ID. */
export enum SiteSettingIdType {
  /** Identify a resource by the Database ID. */
  DatabaseId = 'DATABASE_ID',
  /** Identify a resource by the (hashed) Global ID. */
  Id = 'ID',
...
/** Connection between the siteSetting type and the siteSetting type */
export type SiteSettingToPreviewConnectionEdge = {
  __typename?: 'SiteSettingToPreviewConnectionEdge';
  /** The node of the connection, without the edges */
  node?: Maybe<SiteSetting>;
};

/** Field Group */
export type SiteSetting_Settingspage = AcfFieldGroup & {
  __typename?: 'SiteSetting_Settingspage';
  featuredListings?: Maybe<Array<Maybe<SiteSetting_Settingspage_FeaturedListings>>>;
  /** The name of the ACF Field Group */
  fieldGroupName?: Maybe<Scalars['String']>;
};

export type SiteSetting_Settingspage_FeaturedListings = Listing;

/** The tag type */
export type Tag = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'Tag';
  /** Connection between the tag type and the agent type */
...
/** The tag type */
export type TagAllAgentsArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
  where?: InputMaybe<TagToAgentConnectionWhereArgs>;
};


/** The tag type */
export type TagAllListingArgs = {
  after?: InputMaybe<Scalars['String']>;
  before?: InputMaybe<Scalars['String']>;
  first?: InputMaybe<Scalars['Int']>;
  last?: InputMaybe<Scalars['Int']>;
...
/** Connection between the tag type and the agent type */
export type TagToAgentConnection = {
  __typename?: 'TagToAgentConnection';
  /** Edges for the TagToAgentConnection connection */
  edges?: Maybe<Array<Maybe<TagToAgentConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Agent>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type TagToAgentConnectionEdge = {
  __typename?: 'TagToAgentConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Agent>;
...
/** Arguments for filtering the TagToAgentConnection connection */
export type TagToAgentConnectionWhereArgs = {
  /** Category ID */
  categoryId?: InputMaybe<Scalars['Int']>;
  /** Array of category IDs, used to display objects from one category OR another */
  categoryIn?: InputMaybe<Array<InputMaybe<Scalars['ID']>>>;
...
/** Connection between the tag type and the listing type */
export type TagToListingConnection = {
  __typename?: 'TagToListingConnection';
  /** Edges for the TagToListingConnection connection */
  edges?: Maybe<Array<Maybe<TagToListingConnectionEdge>>>;
  /** The nodes of the connection, without the edges */
  nodes?: Maybe<Array<Maybe<Listing>>>;
  /** Information about pagination in a connection. */
  pageInfo?: Maybe<WpPageInfo>;
...
/** An edge in a connection */
export type TagToListingConnectionEdge = {
  __typename?: 'TagToListingConnectionEdge';
  /** A cursor for use in pagination */
  cursor?: Maybe<Scalars['String']>;
  /** The item at the end of the edge */
  node?: Maybe<Listing>;
...
/** Input for the updateSiteSetting mutation */
export type UpdateSiteSettingInput = {
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: InputMaybe<Scalars['String']>;
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date?: InputMaybe<Scalars['String']>;
  /** The ID of the siteSetting object */
  id: Scalars['ID'];
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder?: InputMaybe<Scalars['Int']>;
  /** The password used to protect the content of the object */
...
export type UpdateSiteSettingPayload = {
  __typename?: 'UpdateSiteSettingPayload';
  /** If a &#039;clientMutationId&#039; input is provided to the mutation, it will be returned as output on the mutation. This ID can be used by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId?: Maybe<Scalars['String']>;
  /** The Post object mutation type. */
  siteSetting?: Maybe<SiteSetting>;
